...
final class TransientCollectionRenderer
{
    ...
    public static function render(TransientCollection $collector): string
    {
        ...
        // attributes.php @generated by https://github.com/ekwi-tech/composer-attribute-collector

        \Ekwi\ComposerAttributeCollector\Attributes::with(fn () => new \Ekwi\ComposerAttributeCollector\Collection(
